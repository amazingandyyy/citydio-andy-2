    ...
    $scope.getDemographics = () => {
        ...
        navigator.geolocation.getCurrentPosition((position) => {
            pitneyBowes.getDemographics(latitude, longitude).then(function(res) {
                ...
                age.forEach(d => {
                    $scope.ageLabel.push(d.description.replace('Population', '').replace('years', 'yrs'));
                ...
                transportation.forEach(d => {
                    $scope.transportationLabel.push(d.description.replace('Public transportation - ', '').replace('Car, truck, or van - ',''));
                ...
                marital.forEach(d => {
                    $scope.maritalLabel.push(d.description.replace('Population % 15 years and over - ', ''));
