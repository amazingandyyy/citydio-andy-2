...
router.get('/getDemographics/:latitude/:longitude', function(req, res) {
    var latitude = req.params.latitude;
    var longitude = req.params.longitude;
    ...
    request.post({
        ...
        var accessToken = JSON.parse(body).access_token;
        var apiUrl = `https://api.pitneybowes.com/location-intelligence/geolife/v1/demographics/bylocation?latitude=${latitude}&longitude=${longitude}`
